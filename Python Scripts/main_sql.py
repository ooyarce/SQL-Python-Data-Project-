...
parameters = {
'sim_comments'      : f'Simulation:  {sim_keys}'                ,
'sm_input_comments' : f'H5DRM Input: {sim_keys}'                ,
'model_comments'    : f'Model:       {sim_keys}'                ,
'bench_comments'    : f'1.25 mts spacing structured: {sim_keys}',
'perf_comments'     : f'Performance metrics: {sim_keys}'        ,
'specs_comments'    : f'Linear-elastic elements: {sim_keys}'    ,
'model_name'        : f'{sim_keys}'                             ,
