...
sim_types        = ['FixBase', 'DRM']         # Options are 'FixBase', 'AbsBound', 'DRM' and 'Validations 
...
stations         = [f'station_s{i}' for i in range(9,10)]  # Generate a list of stations from 'station_s0' to 'station_s8'
Validate         = False
