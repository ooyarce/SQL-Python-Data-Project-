...
from pyseestko.utilities    import mapSimTypeID, getBoxParams # type: ignore
...
'time_step'         : 0.03                                      , # This value is the time step of the analysis in seconds
'total_time'        : 59.97                                     , # This value is the total time of the analysis in seconds
}
