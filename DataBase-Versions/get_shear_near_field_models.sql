SELECT mb.JobName,
CASE SUBSTRING(mb.JobName, 13, 1)
    WHEN '1' THEN 'Near field North'
    WHEN '2' THEN 'Near field Center'
    WHEN '3' THEN 'Near field South'
    WHEN '0' THEN 'Hanging wall'
    ELSE si.Location
...
WHERE mss.Nhistories = 20 AND mss.Nsubs = 4 AND si.Location = 'Near field'
