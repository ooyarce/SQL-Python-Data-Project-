SELECT mb.JobName,
  CASE SUBSTRING(mb.JobName, 13, 1)
    WHEN '4' THEN 'Mid field North'
    WHEN '5' THEN 'Mid field Center'
    WHEN '6' THEN 'Mid field South'
    ELSE si.Location
...
WHERE mss.Nhistories = 20 AND mss.Nsubs = 4 AND si.Location = 'Intermediate field'
